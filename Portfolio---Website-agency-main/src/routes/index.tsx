...
export const Route = createFileRoute("/")({
  head: () => ({
    ...pageMeta("MindLoom", "Onda Studio designs and builds distinctive, high-performing websites for ambitious small businesses.", "/"),
    meta: [
      { title: "MindLoom" },
      { name: "description", content: "Onda Studio designs and builds distinctive, high-performing websites for ambitious small businesses." },
    ],
  }),
  component: HomePage,
});
